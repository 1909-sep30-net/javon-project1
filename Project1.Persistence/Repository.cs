...
namespace Project1.Persistence
{
    ...
    public class Repository : IRepository
    {
        ...
        public BusinessLogic.Customer GetCustomerById(int customerId)
        {
            ...
            Entities.Customer customer = _context.Customer
                .ToList()
        ...
        public BusinessLogic.Location GetLocationById(int locationId)
        {
            ...
            Entities.Location location = _context.Location
                .ToList()
            ...
            IEnumerable<Inventory> inventories = _context.Inventory
                .ToList()
        ...
        public BusinessLogic.Order GetOrderById(int orderId)
        {
            ...
            Entities.Orders order = _context.Orders
                .ToList()
        ...
        public int CreateOrder(int locationId, int customerId, Dictionary<int, int> selectedInventory)
        {
            ...
            _context.Orders
                .Add(additionalOrder);
            Log.Information($"Added the additional order");
            Save();
            ...
            {
                _context.LineItem
                    .Add(additionalLineItem);
            }
            Log.Information($"Added the additional line items");
            Save();
        ...
        private Dictionary<BusinessLogic.Product, int> GetLineItemsByOrderId(int orderId)
        {
            ...
            IEnumerable<LineItem> lineItemList = _context.LineItem
                .ToList()
                .Where(i => i.OrdersId == orderId);
        ...
        public BusinessLogic.Product GetProductById(int productId)
        {
            ...
            Entities.Product product = _context.Product
                .ToList()
